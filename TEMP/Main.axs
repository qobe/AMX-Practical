...
DEFINE_DEVICE
    ...
    dvSwitcher		=	5001:1:0	// 5001:1:0	//Switchback 12x4 Composite Video Switcher
    dvProj		=	5001:2:0	// 5001:2:0	//LightThrower 3000
    dvDVD		=	5001:3:0	// 5001:3:0	//Disco Tech DVD player
    dvCamera		=	5001:4:0	//Sony EVI-D100
    vdvCamera		=	41001:1:0
    vdvKeypad		=	42001:1:0	//Virtual Keypad
    dvKeypad		=	0:4:0		//Keypad device
    dvSatellite		=	5001:9:0	// 5001:9:0	//DirectTV HR-20 DSS Receiver
...
DEFINE_CONSTANT
    ...
    #WARN 'I spent 50hrs on this progam'
...
DEFINE_MODULE 'VirtualKeypad_dr1_0_0' VKP(vdvKeypad, dvKeypad)
...
DEFINE_EVENT
	...
	ONLINE:
	{
	    ...
	    FOR(n = 1; n < 13; n++)
	    {
		send_command vdvKeypad, "'LABEL',n,'-'"
	    }
	    SEND_COMMAND vdvKeypad, "'LABEL5-DVD/CD'"
	    SEND_COMMAND vdvKeypad, "'LABEL6-Camera'"
	    SEND_COMMAND vdvKeypad, "'LABEL7-Sat. Rcvr.'"
	    SEND_COMMAND vdvKeypad, "'LABEL8-Security Camera'"
	    SEND_COMMAND vdvKeypad, "'LABEL12-System Power'"
	}
    }
